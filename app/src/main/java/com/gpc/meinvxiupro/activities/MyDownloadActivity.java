...
public class MyDownloadActivity extends BaseActivity {
    ...
    private void initToolbar() {
        ...
        ((TextView) mCollectToolbar.findViewById(R.id.tool_title))
                .setText(getResources().getString(R.string.my_download));
    ...
    private void initTextView() {
        ((TextView) findViewById(R.id.my_collect_no_data)).setText(getResources().getString(R.string.no_download));
    }
    ...
    private void initListener() {
        mAdapter.setOnClickListener(new OnItemClickListener() {
            ...
            public void onItemClickListener(int position) {
                ...
                bundle.putInt(Constant.BundleConstant.LOAD_TAG, Constant.CommonData.LOAD_LOCAL);
    ...
    private void loadData() {
        ...
        WallpaperUtils.getDownloadWallpaper(new Subscriber<List<ImgsEntity>>() {
            @Override
